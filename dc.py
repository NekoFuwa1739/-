...
discord_token = "https://discord.com/api/webhooks/743861310390927430/7dmHAC_kw--P3-3Jcz9B5MmeW8uFr0rxG0VOMch9yVsa6S-5SD2qBldKLminJpUYq0cU"#とーくん
...
async def on_message(message):
    ...
    if client.user in message.mentions:
        url = 's.mclife.pro:51019'#じぶんのさばのipに変えてね
